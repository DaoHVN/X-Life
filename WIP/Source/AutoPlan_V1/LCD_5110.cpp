...
void LCDWrite(byte data_or_command, byte data)
{
  ...
  digitalWrite(LCD5110_PIN_DC, data_or_command);

  //Send the data
  digitalWrite(LCD5110_PIN_BLK, LOW);
  SPI.transfer(data); //shiftOut(LCD5110_PIN_SD, LCD5110_PIN_SCL, MSBFIRST, data);
  digitalWrite(LCD5110_PIN_BLK, HIGH);
}
...
void LCD5110_Hard_Init(void)
{
  //Configure control pins
  pinMode(LCD5110_PIN_BLK, OUTPUT);
  pinMode(LCD5110_PIN_RST, OUTPUT);
  pinMode(LCD5110_PIN_DC, OUTPUT);
  pinMode(LCD5110_PIN_SD, OUTPUT);
  pinMode(LCD5110_PIN_SCL, OUTPUT);
  pinMode(LCD5110_PIN_BLK, OUTPUT);
  analogWrite(LCD5110_PIN_BLK, 255);
  ...
  digitalWrite(LCD5110_PIN_RST, LOW);
  digitalWrite(LCD5110_PIN_RST, HIGH);
